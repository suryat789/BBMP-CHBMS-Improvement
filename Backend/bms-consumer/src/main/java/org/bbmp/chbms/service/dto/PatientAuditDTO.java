...
/**
 * A DTO for the {@link org.bbmp.chbms.domain.PatientAudit} entity.
 */
public class PatientAuditDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatientAuditDTO)) {
            return false;
        }

        return id != null && id.equals(((PatientAuditDTO) o).id);
    }
