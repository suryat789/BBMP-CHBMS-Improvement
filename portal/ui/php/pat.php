...
$pat = "Select DISTINCT bucode, srf_number, queue_type, t1.queue_name, t2.count, time_added_to_queue from chbms.patient t1 inner join( SELECT queue_name, count(*) as count, min(time_added_to_queue) as earliest FROM chbms.patient group by queue_name ) t2 on t1.time_added_to_queue = t2.earliest";
