...
export JDBC_MYSQL_CONNECTION_USERNAME=
export JDBC_MYSQL_CONNECTION_PASSWORD=
export SPRING_CLOUD_AZURE_EVENTHUB_CONNECTION_STRING=
export SPRING_CLOUD_AZURE_CHECKPOINT_STORAGE_ACCOUNT=
...
To build the final jar and optimize the bms application for production, run:
